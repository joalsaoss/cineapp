      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">         
            <img src="images/slide1.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="images/slide2.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="images/slide3.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="images/slide4.jpg" alt="Slide" title="Some text" >
          </div>
        </div>
